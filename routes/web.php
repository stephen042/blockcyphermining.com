...
Route::get('/investment_plan', [UserController::class, "investment_plan"])->name("investment_plan"); //
...
//verify profile
Route::get("/customer/verifyid", [AccountController::class, "verifyid"])->middleware(["auth"])->name("user.verifyid.view");
Route::post("/customer/verifyid", [AccountController::class, "verifyid"])->middleware(["auth"])->name("verifyid.post");
...
Route::match(["get", "post"], "/admin/verify/{name}/{id?}", [UserController::class, "verify"])->middleware(["auth", "isAdmin"])->name("admin.verify.view");
