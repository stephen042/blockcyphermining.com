...
<body>
    <div class="limiter" style="background-color: #303030">
        <div class="logo-header mostion text-center mx-auto" style="width: 200px;">
            <a href="{{ route('app.home') }}" style="display: flex; padding:2px;">
            <img src="{{ asset('assets/images/logo.png')}}" style="height:65px;width:100%;background-color:#303030;margin-top: 20px;"  alt="">
            </a>
        </div>
        <div class="container-login100" style="background-color: #303030">
            <div class="wrap-login100">
                <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" method="POST"
                    ...
                    <div class="validate-input" style="text-align: center" data-validate="Please enter password">
                        <input type="checkbox" required>
                        <span> I am 18 years of age or older</span>
                        {{-- <hr style="border-top:1px solid green;"> --}}
                    </div>

                    <div class="validate-input" style="text-align: center;margin-top: 8px;" data-validate="Please enter password">
                        <input type="checkbox" required>
                        <span>  I agree to BlockCypherMinings <a href="terms" target="_blank">Terms and conditions</a></span>
                        {{-- <hr style="border-top:1px solid green;"> --}}
                    </div>

                    <div class="validate-input" style="text-align: center;margin-top: 8px;" data-validate="Please enter password">
                        <input type="checkbox" required>
                        <span>I agree to receive BlockCypherMinings and third party emails</span>
                        {{-- <hr style="border-top:1px solid green;"> --}}
                    </div>
