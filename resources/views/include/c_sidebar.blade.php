<div class="nk-sidebar nk-sidebar-fat nk-sidebar-fixed" data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="{{ route('app.home')}}" class="logo-link nk-sidebar-logo h3" style="font-size:2em">
                {{ config("app.name") }}  
            </a>
        </div>
...
<!-- 
                        ...
                        <li class="nk-menu-item">
                            <a href="{{ route('user.verifyid.view') }}" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-user"></em></span>
                                <span class="nk-menu-text">Verify Identity</span>
                            </a>
                        </li>
                        ...
                        <span class="nk-menu-text"> DOWNLOD COINBASE WALLET</span>
                        <li class="nk-menu-item">
                            <a href="https://play.google.com/store/apps/details?id=com.coinbase.android&hl=en&gl=US" target="_blank" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-in"></em></span>
                                <span class="nk-menu-text">ANDROID APP</span>
                            </a>
                        </li>

                        <li class="nk-menu-item">
                            <a href="https://apps.apple.com/us/app/coinbase-buy-bitcoin-ether/id886427730" target="_blank" class="nk-menu-link">
                                <span class="nk-menu-icon"><em class="icon ni ni-wallet-in"></em></span>
                                <span class="nk-menu-text">IOS APP</span>
                            </a>
                        </li>
