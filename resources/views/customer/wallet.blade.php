                                        ...
                                        <div class="nk-wg1 mb-3">
                                            <div class="nk-wg1-group g-2">
                                                ...
                                                <div class="nk-wg1-item mr-xl-4">
                                                    ...
                                                    <div class="nk-wg1-amount">
                                                        <div class="amount text-light">{{ number_format( $wallet->bitcoin_balance, 10, ".","," )}}
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nk-wg1-item ml-lg-auto">
                                                    ...
                                                    <div class="nk-wg1-group g-2">
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                                {{ number_format( $wallet->bitcoin_withdrawals, 10, ".","," )}}
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                                {{ number_format( $wallet->ethereum_withdrawals, 10, ".","," )}}
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                             {{ number_format( $wallet->bitcoin_invested, 10, ".","," )}}
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                               ...
                                                               {{ number_format( $wallet->ethereum_invested, 10, ".","," )}} 
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                               ...
                                                               {{ number_format( $wallet->bitcoin_earned, 10, ".","," )}}   
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                               ...
                                                               {{ number_format( $wallet->ethereum_earned, 10, ".","," )}}     
                                                                </div>
                                                        </div>
