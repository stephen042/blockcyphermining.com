...
@if ($user->vfystatus == 0)
  <script type="text/javascript">
    ...
    // window.location.href="{{ route('user.verifyid.view') }}" 
</script>
@endif
</head>
                                ...
                                <div class="nk-block-between-md g-4">
                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="nk-block-tools gx-3">
                                            ...
                                            <li class="btn-wrap"><a href="https://www.coinbase.com/" target="_blank"
                                                    class="btn btn-icon btn-xl btn-info"><em
                                                        class="icon ni ni-wallet-in"></em></a><span
                                                    class="btn-extext">Buy Crypto</span></li>
                                        </ul>
                                    </div>
                                                        ...
                                                        <div class="card-inner">
                                                            <div class="nk-wg7">
                                                                <div class="nk-wg7-stats">
                                                                    ...
                                                                    <div class="number-lg amount">
                                                                        {{ number_format($account->bitcoin_balance, 10, '.', ',') }}
                                                                    </div>
                                                                </div>
                                                                <div class="nk-wg7-foot">
